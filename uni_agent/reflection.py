...
DEFAULT_SYSTEM_TEMPLATE = (
    ...
    "turn onward. Write advice for someone about to act, never a critique of what they did.\n"
    "Rules:\n"
    ...
    "evidence for.\n"
    "2. Each hint, at most three sentences: refer to the observed mistake as what 'the "
    "previous attempt' did from this state (never 'you did'), then give the corrective "
    "direction: which macro step to take now and which files, functions, or tests to target. "
    "End every hint with the observation the corrected action should produce (so the agent "
    "can internalize action to expected result).\n"
